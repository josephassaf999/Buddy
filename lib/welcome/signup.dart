...
import '../dog walker pages/dog_walker_hompage.dart';
import 'login.dart';
...
class _SignupPageState extends State<SignupPage> {
                          ...
                          return AlertDialog(
                            ...
                            content: Column(
                              ...
                              children: <Widget>[
                                ElevatedButton(
                                  onPressed: () async {
                                    selectedAccountType = 'Dog walker';
                                    Navigator.pop(context);
                                    await saveUserData(selectedAccountType);
                                  },
                                  child: const Text('Dog Walker'),
                                ),
                                ElevatedButton(
                                  onPressed: () async {
                                    selectedAccountType = 'Dog owner';
                                    Navigator.pop(context);
                                    await saveUserData(selectedAccountType);
                                  },
                                  child: const Text('Dog owner'),
                                ),
                              ],
                            ),
                          );
  ...
  Future<void> saveUserData(String selectedAccountType) async {
    try {
      ...
      if (selectedAccountType == 'Dog walker') {
